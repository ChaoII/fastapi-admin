...
<!--							</el-upload>-->
							<el-upload class="h100 personal-user-left-upload">
								<img :src="baseURL+getUserInfos.photo" />
							</el-upload>
						</div>
						<div class="personal-user-right">
							<el-row>
								<el-col :span="24" class="personal-title mb18">{{ currentTime }}，{{ getUserInfos.nicename }}，但行好事，莫问前程！ </el-col>
								<el-col :span="24">
									<el-row>
										<el-col :xs="24" :sm="8" class="personal-item mb6">
											<div class="personal-item-label">昵称：</div>
											<div class="personal-item-value">{{ getUserInfos.nicename }}</div>
										</el-col>
										<el-col :xs="24" :sm="16" class="personal-item mb6">
											<div class="personal-item-label">身份：</div>
											<div class="personal-item-value">{{ getUserInfos.roles[0] }}</div>
										</el-col>
									</el-row>
								</el-col>
								<el-col :span="24">
									<el-row>
										<el-col :xs="24" :sm="8" class="personal-item mb6">
											...
											<div class="personal-item-value">{{ getUserInfos.loginip }}</div>
										</el-col>
										<el-col :xs="24" :sm="16" class="personal-item mb6">
											<div class="personal-item-label">登录时间：</div>
											<div class="personal-item-value">{{ getUserInfos.lastlogin }}</div>
										</el-col>
									</el-row>
								</el-col>
							</el-row>
